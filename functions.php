...
add_shortcode('quote_light', function ($atts, $content = null) {
    ...
    <blockquote class="quote-light">
        <svg class="quote-light-mark" width="39" height="40" viewBox="0 0 39 40" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="quote-light-meta">
            <div class="quote-light-info">
                <cite class="quote-light-cite"><?php echo $cite; ?></cite>
            </div>
        </div>
        <?php endif; ?>
    </blockquote>
...
add_shortcode('figure_caption', 'figure_caption_shortcode');
function figure_caption_shortcode($atts, $content = null) {
    $atts = shortcode_atts(array(
        'caption' => '',
        'alt' => '',
        'class' => 'img-fluid',
...
// Set posts per page for home blog listing (/blogue)
